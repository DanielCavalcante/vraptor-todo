...
public class Inbox implements Serializable {
	...
	public void emptyList(Collection list) {
		if (list == null || list.isEmpty())
			message("msg.empty.list").info();
	}

	public void enterRequiredFields() {
		message("msg.enter.required.fields").warning();
	}

	public void operationNotPerformed() {
		message("msg.operation.not.performed").danger();
	}
